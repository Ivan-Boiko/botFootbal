...
schedule.scheduleJob(new Date(Date.now() + 1 * 30 * 1000), () => {
  const messageBot = `Соскучился! 🤖 Я снова в строю — бодрый, заряженный и готов помогать!
Хоть я и железяка, но душой я с вами на поле. Не забывайте, что я тоже член команды — хоть и с Wi-Fi вместо бутс!
И, кстати... @MaxEfimov1, я всё вижу! 😏 Даже если ты думаешь, что я просто скрипт.

Пусть сегодня будет день, полный побед, голов и хорошего настроения! ⚽🔥`;
